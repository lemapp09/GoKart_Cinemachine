...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        public CinemachineVirtualCamera _camera01;
        public CinemachineVirtualCamera _camera02;
        ...
        private void SwitchCamera()
        {
            if (Input.SwitchCamera) {
                _camera01.Priority = 9;
                _camera02.Priority = 11;
            }  else {
                _camera01.Priority = 11;
                _camera02.Priority = 9;
            }
        }
